...
namespace File_Split_and_Join
{
    ...
    public partial class ucJoin : UserControl
    {
        ...
        private void MenuItemMoveItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                var itemToMoveUp = this.ListViewFiles.Items[i];
                this.ListViewFiles.Items.RemoveAt(i);
                this.ListViewFiles.Items.Insert(i + (stringCommand == "↑" ? -1 : 1), itemToMoveUp);
                ListViewFiles.SelectedItems.Add(this.ListViewFiles.Items[i + (stringCommand == "↑" ? -1 : 1)]);
        ...
        private void Button_Click_StartJoin(object sender, RoutedEventArgs e)
        {
            ...
            if (saveFileDialog1.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                g.FileManager.JoinFiles(files, saveFileDialog1.FileName);
                g.OpenFolder(System.IO.Path.GetDirectoryName(saveFileDialog1.FileName));
            }
        }
    }
